...
![ISO 27001 overview](https://eqqn.github.io/images/ISO_overview.png)
...
![ISMS ALIGNMENT CHART](https://eqqn.github.io/images/ISMS_ALIGNMENT_CHART.png)
...
I am sure someone is working on self-implementing agentic ISO 27001 ISMS, capable of gathering it's own inventories, assessing the risks, assigning reponsibilities (to other agents) and of course writing policies.

But before we are obsolete, there still needs to be a human in the loop.
> "~ChatGPT~ Claude, certify ISO 27001 and make no mistakes! "
